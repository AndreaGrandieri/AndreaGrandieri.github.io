...
![one-face-GUI.gif](https://github.com/AndreaGrandieri/MagicMirror-GBM/raw/main/docs/assets/Overview-GUI/MagicMirror-GBM-GUI/one-face-GUI.gif)
...
Qui i dettagli: [MagicMirror-GBM-OS](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/MagicMirror-GBM-OS.md)
...
- [MMM-AirQuality](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-AirQuality/MMM-AirQuality.md)
- [MMM-DHT-Sensor](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-DHT-Sensor/MMM-DHT-Sensor.md)
- [newsfeed](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/newsfeed/newsfeed.md)
- [MMM-AVStock]([pages/DocumentazioneModuli/MMM-AVStock/MMM-AVStock.md](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-AVStock/MMM-AVStock.md))
- [clock](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/clock/clock.md)
- [weather](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/weather/weather.md)
- [weatherforecast](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/weatherforecast/weatherforecast.md)
- [calendar](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/calendar/calendar.md)
- [MMM-MD](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-MD/MMM-MD.md)
- [MMM-Screencast](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-Screencast/MMM-Screencast.md)
- [MMM-Mail](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-Mail/MMM-Mail.md)
- [MMM-Online-State](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-Online-State/MMM-Online-State.md)
- [MMM-ip](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-ip/MMM-ip.md)
- [MMM-PIR-Sensor](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/DocumentazioneModuli/MMM-PIR-Sensor/MMM-PIR-Sensor.md)
...
Qui i dettagli: [MagicMirror-GBM-IP-Dashboard](https://github.com/AndreaGrandieri/MagicMirror-GBM/blob/main/docs/pages/MagicMirror-GBM-IP-Dashboard.md)
